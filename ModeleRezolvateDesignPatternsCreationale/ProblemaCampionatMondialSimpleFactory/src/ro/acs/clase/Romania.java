...
public class Romania extends AbstractEchipaNationala {
    private String numeEchipa;

    public Romania(String stilJoc, String continent, String numeEchipa) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Romania{");
